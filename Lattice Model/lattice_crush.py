#!/usr/bin/env python3
"""
Extended lattice simulation with higher inflow rates (overcrowded scenario).

Models crowd behavior under intense inflow conditions:
- Increased peak inflow rates (15.5 agents/s)
- Longer simulation duration (1000s)
- Tracks emergent congestion patterns
- Analyzes flow breakdown points
