#!/usr/bin/env python3
"""
Simulates bidirectional crowd flow dynamics with panic effects (overcrowded scenario).
...
params = {
    ...
    'min_snapshot_interval': 10.0  # seconds
}
...
def create_animation(positions_history, directions_history, times_history, n_agents_history):
    ...
    ani_ax.set_title('Overcrowded Flow Simulation')
    ani_ax.grid(True)
